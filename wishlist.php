...
if (isset($_POST['clear_wishlist']) && isset($_SESSION['user_id'])) {
    $user_id = $_SESSION['user_id'];
    mysqli_query($conn, "DELETE FROM `wishlist` WHERE `user_id` = '$user_id'") or die('query failed');
    echo "<script>alert('All products removed from your wishlist'); window.location.href='wishlist.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <section class="pt-5 pb-5">
        <div class="container">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                if (isset($_POST['cart'])) {
                                    ...
                                    if (mysqli_num_rows($res) > 0) {
                                        ...
                                        if (mysqli_num_rows($check_cart_numbers) > 0) {
                                            ...
                                            echo '<script>alert("product added to cart"); window.location.href ="wishlist.php";</script>';
                                        }
                                    }
                                }
                                ...
                                if (isset($_POST['remove'])) {
                                    ...
                                    echo "<script>alert('product removed from the wishlist'); window.location.href ='wishlist.php';</script>";
                                }
                            ?>
                            <tr>
                                <td data-th="Product">
                                    <div class="row">
                                        <div class="col-md-3 text-left">
                                            <a href="product-details.php?p_id=<?php echo $p_id; ?>">
                                                <img src="assets/product-image/<?php echo $p_img; ?>" alt="" class="img-fluid d-none d-md-block rounded mb-2 shadow">
                                            </a>
                                        </div>
                                ...
                                <td data-th="Price">Dz<?php echo $p_price; ?></td>
                                <td class="actions" data-th="">
                                    <div class="text-right">
                                        <form action="" method="post">
                                            <input type="hidden" value="<?php echo $wish_id; ?>" name="wish_id">
                                            <button class="btn btn-white border-secondary bg-white btn-md mb-2" name="remove" value="remove">
            ...
            <!-- Continue Shopping + Clear Button -->
            <div class="row mt-4">
                <div class="col-md-6 text-left">
                    <a href="products.php" style="color:black">
                        <i class="fas fa-arrow-left mr-2" style="color:black"></i> Continue Shopping
                    </a>
                </div>
                <div class="col-md-6 text-right">
                    <form method="post">
                        <button type="submit" name="clear_wishlist" class="btn btn-danger btn-lg">Clear Wishlist</button>
                    </form>
                </div>
            </div>
        </div>
