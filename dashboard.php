...
// Your dashboard page code starts here
?>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card  text-white h-100" style="border-radius:20px; background-color: blue;">
                                <div class="card-body">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card  text-white h-100" style="border-radius:20px; background-color: crimson; ">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card  text-white h-100" style="border-radius:20px; background-color: green;">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card  text-white h-100" style="border-radius:20px; background-color: gray;">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card  text-white h-100" style="border-radius:20px; background-color: darkkhaki; ">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="me-3">
