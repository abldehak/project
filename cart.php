...
if(isset($_POST['clear_cart']) && isset($_SESSION['user_id'])) {
    ...
    // Optional: Show an alert and refresh the page
    echo "<script>alert('All products removed from your cart'); window.location.href='cart.php';</script>";
    exit;
}
?>
<!DOCTYPE html>
         ...
         if(isset($_POST['remove'])){
            ...
            ?>
                            <tr>
                                ...
                                <td data-th="Price">Dz<?php echo $p_price*$qty;?></td>
            ...
            <div class="row mt-4 d-flex align-items-center">
                <div class="col-sm-6 order-md-2 text-right">
                    <form action="checkout.php" method="post" style="display:inline-block;">
                        ...
                        <button type="submit" name="checkout" class="btn btn-dark mb-4 btn-lg pl-5 pr-5">Checkout</button>
                    </form>

                    <!-- Clear Cart button -->
                    <form method="post" style="display:inline-block; margin-left: 150px;">
                        <button type="submit" name="clear_cart" class="btn btn-danger btn-lg mb-4">Clear Cart</button>
                    </form>
                </div>
