...
include_once('includes/config.php');
    if (isset($_POST['submit'])) {
        ...
        move_uploaded_file($_FILES['p_img']['tmp_name'],"assets/img/$p_img");
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row" style="margin-top:1%;">
                                        ...
                                        <div class="col-6"><input type="text" name="p_name"
                                                placeholder="Enter the Product Name" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top:1%;">
                                        ...
                                        <div class="col-6"><input type="file" name="p_img"
                                                placeholder="Enter the Product Image" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top:1%;">
                                        ...
                                        <div class="col-6"><input type="text" name="p_mrp"
                                                placeholder="Enter the Product MRP" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top:1%;">
                                        ...
                                        <div class="col-6"><input type="text" name="p_price"
                                                placeholder="Enter the Product Price" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="margin-top:1%;">
                                        ...
                                        <div class="col-6"><input type="text" name="qty"
                                                placeholder="Enter the Product Qty" value="1" class="form-control"></textarea>
                                        </div>
                                    </div>
