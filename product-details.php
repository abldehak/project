        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          <div class="col-md-8 col-xs-12">
            <form action="#" method="post" class="form">
              ...
              <br>
              <p class="lead">
                <small><del>Dz<?php echo $p_mrp; ?></del></small><strong class="text-dark" style="font-weight: 500;"><?php echo " Dz",$p_price;?></strong>
              </p> <br> 
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <?php
                        ...
                        <?php  } else { ?>
                          <input type="submit" class="btn btn-dark btn-block" style="margin-top:-36px;  width: 150px;" name="addtocart" value="Add To Cart">
                          <?php } ?>
                        </form>
                    </div>
                  </div>
