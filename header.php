                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="pc_ph.php">Pc Peripherals</a>
                            <a class="dropdown-item" href="networking.php">Netwroking</a>
                            <a class="dropdown-item" href="printers.php">Projectors and screeners</a>
                            <a class="dropdown-item" href="cables.php">Power and Cables</a>
